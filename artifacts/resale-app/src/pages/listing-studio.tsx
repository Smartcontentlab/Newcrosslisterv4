    ...
    <div className="space-y-6 pb-28">
      ...
      <section className="grid gap-6 xl:grid-cols-[1.06fr_0.94fr]">
        <div className="cx-panel rounded-2xl p-5 sm:p-6">
          ...
          {photos.length > 0 && <p className="mt-4 text-xs text-muted-foreground">Choose White studio or Gray textured flat lay before processing. Background removal runs in your browser; originals remain available for review or reprocessing at any time.</p>}
        </div>
